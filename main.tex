...
\begin{document}
    ...
    \author{
        ...
        \thanks{
          Hong is with Southern University of Science and Technology (SUSTech), and the University of Hong Kong (HKU) (Corresponding Author. email: ychong@cs.hku.hk).
        }
        \thanks{
          Lv is with with the Department of Electrical and Electronic Engineering, Southern University of Science and Technology (SUSTech) (email: lvbj@mail.sustech.edu.cn).
        }
        \thanks{
          Wang is with the Department of Electrical and Electronic Engineering, Southern University of Science and Technology (SUSTech) (email: wang.r@sustech.edu.cn).
        }
        \thanks{
          Han is with University of Science and Technology of China (USTC), and the University of Hong Kong (HKU) (email: zhenhua@connect.hku.hk).
        }%
        \thanks{
        ...
        \thanks{
          A preliminary version of this work titled ``Online Distributed Job Dispatching with Outdated and Partially-Observable Information'' was published in Proc. of the 16th Annual IEEE International Conference on Mobility, Sensing and Networking (MSN 2020), Tokyo, Japan, December 2020~\cite{hong2020online}.
        }
    }%
    % \author{
    %     \IEEEauthorblockN{

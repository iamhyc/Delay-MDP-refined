...
\newcommand{\wangr}[1]{\textcolor{orange}{#1}}
\newcommand{\hongyc}[1]{{\color{purple}{#1}}}
...
\begin{document}
    ...
    \author{
        Yuncong~Hong,~\IEEEmembership{Member,~IEEE,}
        Bojie~Lv,~\IEEEmembership{Member,~IEEE,}
        Rui~Wang,~\IEEEmembership{Member,~IEEE,}
        Haisheng~Tan,~\IEEEmembership{Member,~IEEE,}

...
\begin{document}
    ...
    \input{src/99-appendix}
    {
      ...
      \fi
      The work is supported in part by a Guangdong Basic and Applied Basic Research Foundation Grant 2019B151513003 and NFSC Grant 61772489.
      Rui Wang (Email: wangr@sustech.edu.cn) and Haisheng Tan (Email: hstan@ustc.edu.cn) are the corresponding authors.

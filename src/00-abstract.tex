% \IEEEtitleabstractindextext{
    \begin{abstract}    
        ...
        In this paper, we investigate an online distributed job dispatching problem in an edge computing system, where multiple access points (APs) collect jobs from the mobile Internet of Things (IoT) devices and then dispatch each job to an edge server.
        The distributed dispatchers on each AP would receive information exchange via periodic broadcast.
        ...
        Due to the highly dynamic latency, the dispatchers have to make job dispatching decisions individually according to partially received and outdated broadcast information.

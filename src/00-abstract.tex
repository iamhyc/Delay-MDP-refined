\IEEEtitleabstractindextext{
    \begin{abstract}
        %NOTE: 1. (straightforward reason why random latency matters? can we?)
        %   
        ...
        %NOTE: 2. investigate the online/distributed/job dispatching/outdated information problem, in edge computing network;

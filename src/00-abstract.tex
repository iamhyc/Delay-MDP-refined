\IEEEtitleabstractindextext{
    \begin{abstract}
        ...
        \comments{
            The signaling mechanism, as periodically broadcast local state information from APs and edge servers, is introduced to establish cooperation among APs.
            As the signaling latency is random and non-negligible, the APs have to update their job dispatching strategy according to outdated and partially observable broadcast information.
        }

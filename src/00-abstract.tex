\IEEEtitleabstractindextext{
    \begin{abstract}
        ...
        In this paper, we propose a novel low-complexity solution framework for distributed job dispatching, called \algname.
        Based on it, the optimization of job dispatching policy can be decoupled via an \emph{alternative policy iteration manner}, so that the distributed policy iteration of each AP can be made according to partial and outdated observation.
        ...
        \hongyc{
            ...
            The extended \algname~leverages model-based reinforcement learning technique to continuously online improve the dispatcher performance.
        }

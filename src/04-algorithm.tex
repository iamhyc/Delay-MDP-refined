...
The following lemma shows the this analytical expression is a performance lower bound (cost upper bound) of our proposed policy in Algorithm \ref{alg_1}.
...
\begin{algorithm}[ht]
    ...
    \While{not converge}{
        ...
        \ForPar{$k\in\apSet$, $m\in\esSet$, $j\in\jSpace$}{
            ...
            \hongyc{(need an if-conditon here)\;}

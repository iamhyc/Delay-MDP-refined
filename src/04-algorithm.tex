...
\comments{
    The subset slit is not trivial and should maximize the parallelism.
    An heuristic greedy algorithm is given as follows.
}
\begin{algorithm}[ht]
    ...
    {
        merge two set with minimum intersection.\;
    }
\end{algorithm}

...
\begin{theorem}[Convergence of Algorithm \ref{alg_3}]
    ...
    \hongyc{As a remark notice that, the convergence of $\hat{u}_{m,j,\xi}$ could be accelerated via cooperation of APs sharing stale observation which obviously dose not affect the correctness of estimation.}
\end{theorem}

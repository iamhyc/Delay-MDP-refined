...
\hongyc{
    \begin{remark}[Scalability Discussion]
        With similar connection ratio between APs and edge servers,
        \begin{enumerate}
            \item For one AP, algorithm complexity only relies on partially observable information;
            \item The update interval would not change.
        \end{enumerate}
    \end{remark}
}

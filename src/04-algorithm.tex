...
\comments{
    \begin{remark}[Algorithm Scalability]
        ...
        \hongyc{
            ...
            For Algorithm \ref{alg_1}, the update interval would be relatively stable when scaling . The simulation results support would be given in the Section \ref{subsec:basic}. 
        }
    \end{remark}
}

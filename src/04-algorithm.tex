...
\label{sec:algorithm}
In this section, we shall propose a novel approximation framework, called \algname, to ``decouple" the centralized optimization on the RHS of the Bellman's equations in Eqn. (\ref{eqn:sp_0}) in each AP for arbitrary system state.

...
The establishment of efficient cooperation among APs and edge servers is one of the major design challenges, \comments{given the signaling overhead introduced in signaling mechanism design.}

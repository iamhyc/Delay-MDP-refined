...
\comments{
    The existing literature, such as \cite{tan-online,MOBIHOC19-ZhouZ,IOTJ18-FanQ,TOC19-LiuC,JSAC19-AlameddineHA}, usually assumed that the transmission latency of global system information sharing or dispatching decisions distributing is negligible and fixed in MAN.
    \hongyc{
        However, in the following literture \cite{TWC18-LyuX,latency-EDGE19}, the network transmission latency could be fluctuate in such extensive network.
    }
}

...
% (1a) general background and bluffing
...
% (1b) why multiple edge servers deployed
...
% (1c) introduce the access points
...
% (2a) deployment in MAN; transmission latency reference
%given the transmission latency (including uploading latency and signaling latency); information sharing; decision making
In this paper, 
...
% (2b) scenario: AP + ES; uploading + signaling latency
...
% (2c) challenge brought by latency

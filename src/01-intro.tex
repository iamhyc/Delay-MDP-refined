...
The establishment of efficient cooperation among edge servers is one of the major design challenges, \comments{given the signaling overhead for distributed information exchange and decision making.}

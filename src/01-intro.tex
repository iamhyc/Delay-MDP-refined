...
\IEEEPARstart{E}{dge} computing is gaining more and more attentions with the prosperity of computation-intensive and delay-sensitive mobile applications.
% computation-intensive, energy-hungry; NN learning/inferring, etc.
...
\begin{itemize}
    ...
    \item To handle the cooperative job dispatching decision with outdated and partial information, a distributed POMDP problem is formulated. A novel low-complexity is proposed.
    We propose a novel low-complexity distributed solution framework for the dispatcher design at the APs.

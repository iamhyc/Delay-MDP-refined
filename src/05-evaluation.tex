...
\label{subsec:basic}
\comments{
    Firstly, we show that our parallel update algorithm could outperform the serial polling policy update, with subset split in Algorithm \ref{alg_0}.
    As illustradted in Fig.\ref{fig:update}.
}
%-----------------------------------------------------------------------------------------------%
\begin{figure}[ht!]                                                                             %
    \centering                                                                                  %

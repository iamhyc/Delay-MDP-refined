...
\hongyc{
    ...
    It can be observed that the learning procedures for all the three statistical parameters converge after at most $XX$ broadcast intervals, which is far before the system achieving the balance dynamic under the dispatching policy.

...
\comments{
    ...
    Without other specified, the illustration of connection matrix between APs and edge servers is given in Fig.\ref{fig:bipartite}.
}
...
\begin{figure}[ht]                                                      %
    ...
    \caption{The illustration of connection matrix between APs and edge servers in the simulation.}
    \label{fig:bipartite}                                                %
\end{figure}                                                            %
%-----------------------------------------------------------------------%

...
\comments{
    ...
    The \emph{connectivity degree} is set as $0.4$, i.e. each AP would have at most $4$ edge servers in its candidate set, and adjacency matrix for the generated bipartite map between APs and edge servers is illustrated in Fig.\ref{fig:bipartite}.
}

...
\revision{
    ...
    \begin{example}
        {%
            As illustrated in Fig.\ref{fig:osi_example}, there are four APs and three edge servers collocated with the APs indexed with $1,2,4$, respectively, in the edge computing system, where the solid directed lines show all the possible job dispatching paths for the APs.

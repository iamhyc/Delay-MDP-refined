...
Hence, we define the cost function per broadcast interval as follows, \comments{given the information contained in periodic broadcast.}
...
\comments{
    The count function per broadcast interval could be taken as a uniform sampling of cost function per time slot.
}

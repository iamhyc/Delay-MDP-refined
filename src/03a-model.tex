...
\comments{
    ...
    \hongyc{
        This implies that the resource allocation is fixed for some types of jobs supported in the edge computing system, which is not the optimization issue in this paper's consideration.
    }

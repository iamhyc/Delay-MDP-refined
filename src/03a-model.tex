...
In this edge computing network, APs and edge servers periodically broadcast their state information (defined in Section \ref{subsec:broadcast}), and \hongyc{each AP will try to} updates its strategy of job dispatching when receiving the broadcast state information.

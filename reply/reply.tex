...
\begin{document}
    ...
    \response{
        ...
        In the original manuscript, the "failed transmission" occurred only when "some broadcast information may be discarded by the routers after a certain number of hops", which results in partially observable state information for each AP.
        \hongyc{

...
\begin{document}
    ...
    \response{
        ...
        Specifically, each AP makes scheduling decision according to the state information of APs in its \hongyc{conflict AP set} and edge servers in its \hongyc{candidate server set}.
        The state information of other nodes is not requested, the state information transmission from those nodes to the AP is tolerable.
        %
        ...
        For example, if $k$-th AP is in the \hongyc{conflict AP set} of the $m$-th AP and the state information transmission from the $k$-th AP failed, the $m$-th AP may request retransmissions until a successful reception.
    ...
    \response{
        ...
        In face, the edge servers also broadcast their state information to the APs \hongyc{in the potential AP set}.
        ...
        \hongyc{It is necessary for the APs to collect task queueing information from edge servers, even it is outdated.}
    ...
    \response{
        ...
        Yes, the job response time includes the job processing time on the processing server \hongyc{plus the uploading time from the AP the the edge server}.
    ...
    \response{
        ...
        \hongyc{
            To the best of our knowledge, there are no existing methods proposed to solve job dispatching with outdated and partial information in edge computing systems.

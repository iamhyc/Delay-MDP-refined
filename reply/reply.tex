...
\begin{document}
    ...
    \response{
        ...
        Therefore, the $1$-st AP should use GSI to predict the whole system states and generate a global dispatching decisions to be updated on all APs.
    ...
    \response{
        ...
        However, to the best of our knowledge, there are no existing methods proposed to solve job dispatching with outdated and partial information of the edge computing system because it is infeasible to solve Bellman's equation in the considered scenario.
        \hongyc{
            In fact, the three baselines are commonly considered in the existing literature.
            For example, \dots
            % The basedline proposed resembles other popular algorithms in this field.
        }

...
\begin{document}
    ...
    \response{
        ...
        Specifically, each AP makes scheduling decision according to the state information of APs in its \emph{conflict AP set} and edge servers in its \emph{candidate server set}.
        The state information of other nodes is not requested, and the state information transmission from those nodes to the AP is tolerable.
        %
        ...
        For example, if $k$-th AP is in the \emph{conflict AP set} of the $m$-th AP and the state information transmission from the $k$-th AP failed, the $m$-th AP may request retransmissions until a successful reception.

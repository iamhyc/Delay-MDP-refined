...
\begin{document}
    ...
    \response{
        ...
        To the best of our knowledge, there are no existing methods proposed to solve job dispatching with outdated and partial information of the system.
        ...
        % solve Bellman's equation in the considered scenario.
        ...
        %     However, to the best of our knowledge, there are no existing methods proposed to solve job dispatching with outdated and partial information of the system because it is infeasible to solve Bellman's equation in the considered scenario.
        %     In fact, the three baselines are commonly considered in the existing literature.
        %     For example, \dots
        % }
    }

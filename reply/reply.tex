...
\begin{document}
    ...
    \response{
        ...
        For the generalization of description, we claim that both APs and edge servers broadcast their state information.
        There is no contradiction, and this model can be trivially extended to the scenario where the APs and edge servers are deployed separately.
